...
const CessnaCitationX = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const cost = costPerHour * hours + (distance * 2); // Cost based on hours and distance
    setTotalCost(cost);
    ...
    <div>
      <div className="embed-responsive embed-responsive-21by9">
        <iframe
          width="100%"
          height="641"
          src="https://www.youtube.com/embed/A4Bf0b5Ytx0"
          title="Cessna Citation X interior and exterior tour"
          frameBorder="0"
      ...
      <div className="container back" style={{ padding: '1%' }} id="specs1">
        <div className="all">
          <div className="tr">
            <div className="row">
              ...
              <div className="col-md-6 yu">
                <div className="eq">
                  <h3>Cessna Citation x Specifications</h3>
                  <ul>
                    <li><strong>Maximum Speed:</strong> 600 mph</li>
                    <li><strong>Range:</strong> 3,000 nautical miles</li>
                    <li><strong>Fuel Capacity:</strong> 20,000 lbs</li>
                    <li><strong>Passenger Capacity:</strong> 12</li>
                    <li><strong>Cost per Hour:</strong> $5,000</li>
                  </ul>
                </div>
              </div>
...
export default CessnaCitationX;

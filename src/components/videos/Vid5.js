    ...
    <div>
      <div className="embed-responsive embed-responsive-21by9">
        <iframe
          width="100%"
          height="641"
          src="https://www.youtube.com/embed/kzw1lkMYz6U"
          title="Piper M600 / SLS"
          frameBorder="0"
      ...
      <div className="container back" style={{ padding: '1%' }} id="specs5">
        <div className="all">
          <div className="row">
            ...
            <div className="col-md-6 yu">
              <div className="eq">
                <ul>
                  <li><h3>Piper M600 Specifications</h3></li>
                  <li><strong>Maximum Speed:</strong> 274 mph</li>
                  <li><strong>Range:</strong> 1,484 nautical miles</li>
                  <li><strong>Fuel Capacity:</strong> 900 lbs</li>
                  <li><strong>Passenger Capacity:</strong> 6</li>
                  <li><strong>Cost per Hour:</strong> $1,200</li>
                </ul>
              </div>
            </div>

  ...
  return (
    <div>
      <iframe
        width="1351"
        height="641"
        src="https://www.youtube.com/embed/_ejU5OdqIi8"
        title="The Gulfstream G650 Cabin"
        frameBorder="0"
      ...
      <div className="container back" style={{ padding: '1%' }} id="specs2">
        <div className="all">
          <div className="row">
            {/* Plane Specifications */}
            <div className="col-md-6 yu">
              <div className="eq">
                <h3>Gulfstream G650 Specifications</h3>
                <ul>
                  <li><strong>Maximum Speed:</strong> 610 mph</li>
                  <li><strong>Range:</strong> 7,000 nautical miles</li>
                  <li><strong>Fuel Capacity:</strong> 44,200 lbs</li>
                  <li><strong>Passenger Capacity:</strong> 18</li>
                  <li><strong>Cost per Hour:</strong> $8,000</li>
                </ul>
              </div>
            </div>

...
const AirbusH160Specifications = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Calculate cost
    const cost = costPerHour * hours + (distance * 3); // Adjust distance factor as needed
  ...
  const updateChart = (hours, cost, distance) => {
    const powerConsumption = (hours * 50) + (distance * 0.3); // Adjust power consumption as needed
    ...
    <div>
      <div className="embed-responsive embed-responsive-21by9">
        <iframe
          width="100%"
          height="641"
          src="https://www.youtube.com/embed/wnyeHDTI3tE"
          title="H160 - DANCING ON AIR"
          frameBorder="0"
      ...
      <div className="container back" style={{ padding: '1%' }} id="specs9">
        <div className="all">
          <div className="row">
            ...
            <div className="col-md-6 yu">
              <div className="eq">
                <ul>
                  <li><h3>Airbus H160 Specifications</h3></li>
                  <li><strong>Maximum Speed:</strong> 160 knots</li>
                  <li><strong>Range:</strong> 400 nautical miles</li>
                  <li><strong>Fuel Capacity:</strong> 2,500 lbs</li>
                  <li><strong>Passenger Capacity:</strong> 12</li>
                  <li><strong>Cost per Hour:</strong> $2,000</li>
                </ul>
              </div>
            </div>
...
export default AirbusH160Specifications;

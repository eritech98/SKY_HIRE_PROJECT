    ...
    <div>
      <div className="embed-responsive embed-responsive-21by9">
        <iframe
          width="100%"
          height="641"
          src="https://www.youtube.com/embed/GQoSOF5D1d4"
          title="Luxurious Private Helicopter Sikorsky S76D Walkaround and Cockpit Tour"
          frameBorder="0"
      ...
      <div className="container back" style={{ padding: '1%' }} id="specs6">
        <div className="all">
          <div className="row">
            ...
            <div className="col-md-6 yu">
              <div className="eq">
                <ul>
                  <li><h3>Sikorsky S-76 Specifications</h3></li>
                  <li><strong>Maximum Speed:</strong> 178 mph</li>
                  <li><strong>Range:</strong> 400 nautical miles</li>
                  <li><strong>Fuel Capacity:</strong> 2,458 lbs</li>
                  <li><strong>Passenger Capacity:</strong> 12</li>
                  <li><strong>Cost per Hour:</strong> $2,500</li>
                </ul>
              </div>
            </div>
